...
const GenerateReportModal = ({ isOpen, onClose, onError }) => {
  ...
  const loadProperties = async () => {
    ...
    try {
      ...
      console.log('Extracted properties:', propertyList);
      
      setProperties(Array.isArray(propertyList) ? propertyList : []);
    } catch (error) {
      console.error('Failed to load properties:', error);
      onError('Failed to load properties list.');
      setProperties([]);
    } finally {
...
Property Filter: ${selectedPropertyName}
        ...
        <form onSubmit={handleGenerateReport} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select 
              ...
              value={reportSettings.propertyId}
              onChange={(e) => setReportSettings({
                ...reportSettings,
                propertyId: e.target.value
              })}
              disabled={generating || loadingProperties}
            >
            ...
            <p className="text-xs text-gray-500 mt-1">
              Select a specific property or generate a report for all properties
            </p>
          </div>
