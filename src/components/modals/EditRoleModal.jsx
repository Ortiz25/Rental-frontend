                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          checked={permissions.every(p => roleData.permissions.includes(p))}
                          onChange={(e) => {
                            if (e.target.checked) {
                              setRoleData({
                                ...roleData,
                                permissions: [...new Set([...roleData.permissions, ...permissions])]
                              });
                            } else {
                              setRoleData({
                                ...roleData,
                                permissions: roleData.permissions.filter(p => !permissions.includes(p))
                              });
                            }
                          }}
                        />
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-yellow-700">
                    This is a default system role. Some settings cannot be modified.
                  </p>
                </div>
              </div>
            )}
